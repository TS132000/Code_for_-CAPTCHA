...
#### 试验二：删掉1最后两个特征为视图一，删掉 最前面两个特征为视图二###########
del_view1 = 68
del_view2 = 3
del_view2_iloc = 2
train_feat_view1 = train_feat.iloc[:,:del_view1]
train_feat_view2 = train_feat.iloc[:,del_view2_iloc:]
train_feat_view1_original = train_feat_view1
train_feat_view2_original = train_feat_view2
#############缓冲池视图划分###########
U_view1 = U_.iloc[:,:del_view1+1]
U_view2 = U_.iloc[:,del_view2_iloc+1:]
U_view1_original = U_view1
U_view2_original = U_view2
U_view1_test = U_view1.ix[:,1:]
U_view2_test = U_view2
###############test_feat视图划分#########################3
test_feat_view1 = test_feat.iloc[:,:del_view1]
test_feat_view2 = test_feat.iloc[:,del_view2_iloc:]
...
add_true_view2 = U_array_add.ix[0:q - 1, del_view2:]
add_false_view2 = U_array_add.ix[U_array_add.shape[0] - n:,del_view2 :]
...
U_view2_test = U_.iloc[:,del_view2:]
...
add_true_view1 = U_array_add.ix[0:q - 1, :del_view1]
add_true_view1 = add_true_view1.ix[:, 1:]
add_false_view1 = U_array_add.ix[U_array_add.shape[0] - n:,:del_view1]
